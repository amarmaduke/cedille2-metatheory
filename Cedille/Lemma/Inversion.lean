...
namespace Cedille
  ...
  @[simp] lemma refl_not_Jh : refl t1 ≠ subst u1 u2 := by inv
  @[simp] lemma refl_not_promote : refl t1 ≠ promote q1 := by inv
  @[simp] lemma refl_not_delta : refl t1 ≠ delta q1 := by inv
  @[simp] lemma refl_not_phi : refl t1 ≠ phi q1 q2 := by inv
  @[simp] lemma refl_not_bind : refl t1 ≠ Syntax.bind b q1 q2 := by inv

  @[simp] lemma Jh_not_const : subst t1 t2 ≠ const k := by inv
  @[simp] lemma Jh_not_typeu : subst t1 t2 ≠ typeu := by inv
  @[simp] lemma Jh_not_kindu : subst t1 t2 ≠ kindu := by inv
  @[simp] lemma Jh_not_free : subst t1 t2 ≠ free x := by inv
  @[simp] lemma Jh_not_bound : subst t1 t2 ≠ bound i := by inv
  @[simp] lemma Jh_not_lam : subst t1 t2 ≠ lam m q1 q2 := by inv
  @[simp] lemma Jh_not_pi : subst t1 t2 ≠ pi m q1 q2 := by inv
  @[simp] lemma Jh_not_inter : subst t1 t2 ≠ inter q1 q2 := by inv
  @[simp] lemma Jh_not_app : subst t1 t2 ≠ app m q1 q2 := by inv
  @[simp] lemma Jh_not_pair : subst t1 t2 ≠ pair q1 q2 q3 := by inv
  @[simp] lemma Jh_not_fst : subst t1 t2 ≠ proj i q1 := by inv
  @[simp] lemma Jh_not_eq : subst t1 t2 ≠ eq q1 q2 q3 := by inv
  @[simp] lemma Jh_not_refl : subst t1 t2 ≠ refl q1 := by inv
  @[simp] lemma Jh_not_promote : subst t1 t2 ≠ promote q1 := by inv
  @[simp] lemma Jh_not_delta : subst t1 t2 ≠ delta q1 := by inv
  @[simp] lemma Jh_not_phi : subst t1 t2 ≠ phi q1 q2 := by inv
  @[simp] lemma Jh_not_bind : subst t1 t2 ≠ Syntax.bind b q1 q2 := by inv
  ...
  @[simp] lemma promote_not_Jh : promote t1 ≠ subst u1 u2 := by inv
  @[simp] lemma promote_not_delta : promote t1 ≠ delta q1 := by inv
  @[simp] lemma promote_not_phi : promote t1 ≠ phi q1 q2 := by inv
  ...
  @[simp] lemma delta_not_Jh : delta t1 ≠ subst u1 u2 := by inv
  @[simp] lemma delta_not_promote : delta t1 ≠ promote q1 := by inv
  @[simp] lemma delta_not_phi : delta t1 ≠ phi q1 q2 := by inv
  @[simp] lemma delta_not_bind : delta t1 ≠ Syntax.bind b q1 q2 := by inv

  @[simp] lemma phi_not_const : phi t1 t2 ≠ const k := by inv
  @[simp] lemma phi_not_typeu : phi t1 t2 ≠ typeu := by inv
  @[simp] lemma phi_not_kindu : phi t1 t2 ≠ kindu := by inv
  @[simp] lemma phi_not_free : phi t1 t2 ≠ free x := by inv
  @[simp] lemma phi_not_bound : phi t1 t2 ≠ bound i := by inv
  @[simp] lemma phi_not_lam : phi t1 t2 ≠ lam m q1 q2 := by inv
  @[simp] lemma phi_not_pi : phi t1 t2 ≠ pi m q1 q2 := by inv
  @[simp] lemma phi_not_inter : phi t1 t2 ≠ inter q1 q2 := by inv
  @[simp] lemma phi_not_app : phi t1 t2 ≠ app m q1 q2 := by inv
  @[simp] lemma phi_not_pair : phi t1 t2 ≠ pair q1 q2 q3 := by inv
  @[simp] lemma phi_not_fst : phi t1 t2 ≠ proj i q1 := by inv
  @[simp] lemma phi_not_eq : phi t1 t2 ≠ eq q1 q2 q3 := by inv
  @[simp] lemma phi_not_refl : phi t1 t2 ≠ refl q1 := by inv
  @[simp] lemma phi_not_Jh : phi t1 t2 ≠ subst u1 u2 := by inv
  @[simp] lemma phi_not_promote : phi t1 t2 ≠ promote q1 := by inv
  @[simp] lemma phi_not_delta : phi t1 t2 ≠ delta q1 := by inv
  @[simp] lemma phi_not_bind : phi t1 t2 ≠ Syntax.bind b q1 q2 := by inv
  ...
  @[simp] lemma bind_not_Jh : Syntax.bind b t1 t2 ≠ subst u1 u2 := by inv
  ...
  @[simp] lemma bind_not_phi : Syntax.bind b t1 t2 ≠ phi q1 q2 := by inv
