...
namespace Cedille
  ...
  @[simp] lemma const_not_J : @const n k ≠ J := by inv
  ...
  @[simp] lemma typeu_not_J : @typeu n ≠ J := by inv
  ...
  @[simp] lemma kindu_not_J : @kindu n ≠ J := by inv
  ...
  @[simp] lemma free_not_J : @free n x ≠ J := by inv
  ...
  @[simp] lemma bound_not_J : @bound n i ≠ J := by inv
  ...
  @[simp] lemma lam_not_J : lam m t1 t2 ≠ J := by inv
  ...
  @[simp] lemma pi_not_J : pi m t1 t2 ≠ J := by inv
  ...
  @[simp] lemma inter_not_J : inter t1 t2 ≠ J := by inv
  ...
  @[simp] lemma app_not_J : app m t1 t2 ≠ J := by inv
  ...
  @[simp] lemma pair_not_J : pair t1 t2 t3 ≠ J := by inv
  ...
  @[simp] lemma fst_not_J : fst t1 ≠ J := by inv
  ...
  @[simp] lemma snd_not_J : snd t1 ≠ J := by inv
  ...
  @[simp] lemma eq_not_J : eq t1 t2 t3 ≠ J := by inv
  ...
  @[simp] lemma refl_not_J : refl t1 ≠ J := by inv
  ...
  @[simp] lemma J_not_const : @J n ≠ const k := by inv
  @[simp] lemma J_not_typeu : @J n ≠ typeu := by inv
  @[simp] lemma J_not_kindu : @J n ≠ kindu := by inv
  @[simp] lemma J_not_free : @J n ≠ free x := by inv
  @[simp] lemma J_not_bound : @J n ≠ bound i := by inv
  @[simp] lemma J_not_lam : @J n ≠ lam m q1 q2 := by inv
  @[simp] lemma J_not_pi : @J n ≠ pi m q1 q2 := by inv
  @[simp] lemma J_not_inter : @J n ≠ inter q1 q2 := by inv
  @[simp] lemma J_not_app : @J n ≠ app m q1 q2 := by inv
  @[simp] lemma J_not_pair : @J n ≠ pair q1 q2 q3 := by inv
  @[simp] lemma J_not_fst : @J n ≠ fst q1 := by inv
  @[simp] lemma J_not_snd : @J n ≠ snd q1 := by inv
  @[simp] lemma J_not_eq : @J n ≠ eq q1 q2 q3 := by inv
  @[simp] lemma J_not_refl : @J n ≠ refl q1 := by inv
  @[simp] lemma J_not_promote : @J n ≠ promote q1 := by inv
  @[simp] lemma J_not_delta : @J n ≠ delta q1 := by inv
  @[simp] lemma J_not_phi : @J n ≠ phi q1 q2 q3 := by inv
  @[simp] lemma J_not_bind : @J n ≠ Syntax.bind b q1 q2 := by inv
  ...
  @[simp] lemma promote_not_J : promote t1 ≠ J := by inv
  ...
  @[simp] lemma delta_not_J : delta t1 ≠ J := by inv
  ...
  @[simp] lemma phi_not_J : phi t1 t2 t3 ≠ J := by inv
  ...
  @[simp] lemma bind_not_J : Syntax.bind b t1 t2 ≠ J := by inv
