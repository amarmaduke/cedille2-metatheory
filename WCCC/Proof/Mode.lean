...
namespace WCCC
  ...
  theorem proof_mf_to_m0 : m1 ∈ m2 -> Γ ⊢[m1] t : A -> Γ ⊢[m2] t : A := by {
    ...
    case app Γ m3 f m4 A B a j1 j2 ih1 ih2 => sorry
    ...
    case snd Γ t A B m j1 j2 ih1 =>
      constructor; exact j1; apply mem_trans j2 jm
    case eq Γ A a b j1 j2 j3 ih1 ih2 ih3 =>
